...
<div class="inside_con">
	<div id="left">
		...
		<div class="left_dh">
            <ul>
                ...
                <li><a href="liucheng2.html" id="sg2">项目设计管理流程</a></li>
                ...
                <li><a href="" class="hover" id="sg7">洁净室施工作业流程</a></li>
            </ul>
		</div>
	</div>
	<!--Left End-->
	<div id="right">
		...
		<div class="right_dh">洁净室施工作业流程</div>
		<div class="right_con">
			<!--Conetent-->
			<div><img src="../images/sg7.jpg" /></div>
			<!--Conetent-->
		</div>
	</div>
	<!--Right End-->
...
<script>
    function changeFlow(obj){
        $(obj).siblings("a").removeClass();
        $(obj).addClass('hover');
        if(obj.id == 'sg1'){
            $("sg00").sibling("div").hide();
            $("sg00").show();
        }
    }
</script>
